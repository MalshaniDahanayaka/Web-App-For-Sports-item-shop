...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Sep 15, 2021 at 03:33 PM
...
INSERT INTO `items` (`id`, `sportName`, `productType`, `brand`, `size`, `prize`, `countOfItems`, `category`, `imagePath`) VALUES
...
('BatBatnikmed', 'Batminton', 'Bat', 'nike', 'medium', 56777, 5, '', 'img/6.jpg');
COMMIT;
