...
function register_user($first_name, $last_name, $username, $email, $password)
{
   ...
   if (email_exists($email)) {
      ...
      $msg = "Please click the below link to activate your account,
        http://localhost/UserAccount/activate.php?email=$email&code=$validation_code";

      $headers = "From: sports.arena.sl@gmail.com";
